...
class TailPrinterTests extends FunSuite {

  override def suiteName = "Tail Printer suite"
  ...
  private def checkSort(sort: Sort): Unit = {
    ...
    val directPrint: String = TailPrinter.toString(sort)
    println(directPrint)

    val parser = Parser.fromString(directPrint)
    val parsedAgain: Sort = parser.parseSort
    val printAgain: String = TailPrinter.toString(parsedAgain)
  ...
  private def checkTerm(term: Term): Unit = {
    ...
    val directPrint: String = TailPrinter.toString(term)
    println(directPrint)
  ...
  private def checkCommand(cmd: Command): Unit = {
    ...
    val directPrint: String = TailPrinter.toString(cmd)
    println(directPrint)
  ...
  test("Printing Commands Reponses") {
    ...
    def printGenRes(res: GenResponse): String = TailPrinter.toString(res) 
    ...
    def printGetAssignRes(res: GetAssignmentResponse): String = TailPrinter.toString(res)
    ...
    def printCheckSat(res: CheckSatResponse): String = TailPrinter.toString(res) 
    ...
    def printGetValue(res: GetValueResponse): String = TailPrinter.toString(res)
  ...
  test("Printing deep trees") {
    ...
    println(TailPrinter.toString(t0))
    ...
    //checkTerm(t3)
    //println(TailPrinter.toString(t3))
